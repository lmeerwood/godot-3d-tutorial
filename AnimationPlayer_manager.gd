...
var states = {
	...
	"Pistol_idle":["Pistol_fire", "Pistol_reload", "Pistol_uneqip","Pistol_idle"],
	"Pistol_reload":["Pistol_idle"],
	"Pistol_unequip":["Idle_unarmed"],
	
	"Rifle_equip":["Rifle_idle"],
	"Rifle_fire":["Rifle_idle"],
	"Rifle_idle":["Rifle_fire", "Rifle_reload", "Rifle_uneqip","Rifle_idle"],
...
func set_animation(animation_name):
	if animation_name == current_state:
		print("AnimationPlayer_Manger.gd -- WARNING: animation is already ", animation_name)
		return true
